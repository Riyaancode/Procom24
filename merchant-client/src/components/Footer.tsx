      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
              ...
              <form className="w-full">
                ...
                >
                  <input
                    type="email"
                    id="UserEmail"
                    placeholder="babar@gmail.com"
                    className="w-full border-none sm:text-sm"
                  />

                  <button
                    className="mt-1 w-full bg-[#744FEA] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    Subscribe
                  </button>
                </div>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">&copy; 2024. Hamara Pay. All rights reserved.</p>
